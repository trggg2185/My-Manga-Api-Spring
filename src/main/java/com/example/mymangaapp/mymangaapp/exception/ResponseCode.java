...
public enum ResponseCode {
    ...
    */
    ...
    MANGA_STATUS_INVALID("3021", "Trạng thái truyện có tối đa {max} ký tự!", HttpStatus.BAD_REQUEST),
    MANGA_DESCRIPTION_INVALID("3022", "Mô tả truyện có tối đa {max} ký tự!", HttpStatus.BAD_REQUEST),
    TOKEN_REQUIRED("3023", "Chuỗi token không được để trống!", HttpStatus.BAD_REQUEST),
    CHAPTER_INDEX_REQUIRED("3024", "Số chương không được để trống!", HttpStatus.BAD_REQUEST),
    CHAPTER_INDEX_POSITIVE("3025", "Số chương phải là số nguyên dương!", HttpStatus.BAD_REQUEST),
    CHAPTER_TITLE_INVALID("3026", "Tiêu đề chương có tối đa {max} ký tự!", HttpStatus.BAD_REQUEST),
    PAGE_URLS_REQUIRED("3027", "Danh sách url của ảnh không được để trống!", HttpStatus.BAD_REQUEST),
    PERMISSION_NAME_REQUIRED("3028", "Tên quyền không được để trống!", HttpStatus.BAD_REQUEST),
